...
class CreatePromomotionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('promomotions', function (Blueprint $table) {
            $table->id();
        ...
        Schema::table('promomotions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('promomotions');
    }
}
