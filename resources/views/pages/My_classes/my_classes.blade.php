...
@section('title')
    {{ trans('My_Class_trans.title_page') }}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <form action="{{ route('Classrooms.update', 'test') }}" method="post">
                                                    ...
                                                    <div class="row">
                                                        <div class="col">
                                                            <label for="Name"
                                                                   class="mr-sm-2">{{ trans('My_Class_trans.Name_class') }}
                                                                :</label>
                                                        ...
                                                        <div class="col">
                                                            <label for="Name_en"
                                                                   class="mr-sm-2">{{ trans('My_Class_trans.Name_class_en') }}
                                                                :</label>
                                                    ...
                                                    <div class="form-group">
                                                        <label
                                                            for="exampleFormControlTextarea1">{{ trans('My_Class_trans.Name_Grade') }}
                                                            :</label>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title"
                                                    id="exampleModalLabel">
                                                    {{ trans('My_Class_trans.delete_class') }}
                                                </h5>
                                                <button type="button" class="close" data-dismiss="modal"
                                                        aria-label="Close">
                                                    <span aria-hidden="true">&times;</span>
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('Classrooms.destroy', 'test') }}"
                                                    ...
                                                    {{ method_field('Delete') }}
                                                    @csrf
                                                    {{ trans('My_Class_trans.Warning_Grade') }}
                                                    <input id="id" type="hidden" name="id" class="form-control"
                                                           value="{{ $My_Class->id }}">
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">{{ trans('My_Class_trans.Close') }}</button>
                                                        <button type="submit"
                                                                class="btn btn-danger">{{ trans('My_Class_trans.submit') }}</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                        ...
                        <form class=" row mb-30" action="{{ route('Classrooms.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                <div class="repeater">
                                    <div data-repeater-list="List_Classes">
                                        <div data-repeater-item>
                                            <div class="row">
                                                ...
                                                <div class="col">
                                                    <label for="Name_en"
                                                           class="mr-sm-2">{{ trans('My_Class_trans.Name_Grade') }}
                                                        :</label>
                                                ...
                                                <div class="col">
                                                    <label for="Name_en"
                                                           class="mr-sm-2">{{ trans('My_Class_trans.Processes') }}
                                                        :</label>
                                                    <input class="btn btn-danger btn-block" data-repeater-delete
                                                           type="button" value="{{ trans('My_Class_trans.delete_row') }}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mt-20">
                                        <div class="col-12">
                                            <input class="button" data-repeater-create type="button" value="{{ trans('My_Class_trans.add_row') }}"/>
                                        </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('delete_all') }}" method="POST">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">{{ trans('My_Class_trans.Close') }}</button>
                        <button type="submit" class="btn btn-danger">{{ trans('My_Class_trans.submit') }}</button>
                    </div>
                </form>
            </div>
        </div>
