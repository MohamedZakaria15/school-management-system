                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($promotions as $promotion)
                                            <tr>
                                                ...
                                                <td>{{$promotion->FG->Name}}</td>
                                                <td>{{$promotion->academic_year}}</td>
                                                <td>{{$promotion->F->Name_Class}}</td>
                                                <td>{{$promotion->FS->Name_Section}}</td>
                                                <td>{{$promotion->tt->Name}}</td>
                                                <td>{{$promotion->academic_year_new}}</td>
                                                <td>{{$promotion->bb->Name_Class}}</td>
                                                <td>{{$promotion->ss->Name_Section}}</td>
                                                <td>
