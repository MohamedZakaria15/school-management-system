                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#students-menu">
                            <div class="pull-left"><i class="fas fa-user-graduate"></i></i><span
                        ...
                        <ul id="students-menu" class="collapse" data-parent="#sidebarnav">
                            ...
                            <li> <a href="{{route('Promomotion.index')}}">{{trans('main_trans.Students_Promotions')}} </a> </li>
                            <li> <a href="{{route('Promomotion.create')}}">{{trans('أدارة ترقية الطلاب')}} </a> </li>
                        </ul>
                    </li>
                    <li>
...
{{--                         //   <li> <a href="{{url('show_table')}}">{{trans('main_trans.List_Parents')}}</a> </li>--}}
                        </ul>
                    </li>
